...
import ConverterComprimento from '../features/ConverterComprimento';
import { fontSizes, fontFamily } from '../utils/fonts';
import { colors } from '../utils/colors';

const TelaComprimento = () => {
  ...
  const opcoesPicker = [
    ...
    { label: 'Metro', value: 'm' },
    { label: 'Pé', value: 'pe' },
    { label: 'Polegada', value: 'pol' },
  ];

  const [valor, setValor] = useState(0);
  const [medidaOriginal, setMedidaOriginal] = useState('cm');
  const [medidaConversao, setMedidaConversao] = useState('m');
        ...
        <ScrollView>
          <View style={styles.container}>
            ...
            <View style={styles.card}>
              <Text style={styles.cardTitulo}>Comprimento</Text>
              <FontAwesome6 name="ruler-horizontal" size={35} color={colors.preto} />
            </View>
            <InputTexto
              label="Valor"
